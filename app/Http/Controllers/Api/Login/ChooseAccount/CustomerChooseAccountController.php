...
class CustomerChooseAccountController extends ChooseAccountController
{
    /**
    ...
    /**
     * Create a new CustomerChooseAccountController instance.
    ...
    public function __construct(ChooseSpecificAccountRequest $request, UsersAccountService $usersAccountService, UserLoggedInResource $userLoggedInResource)
    {
        ...
        $this->account = AccountType::customer();
    }
